        ...
        for k in arange(segmentar[0], segmentar[1]):
            ...
            if k == segmentar[0]:
                ...
                if r_segm[1] == sec_ej[0]:  # Seg. negativo
                    ...
                    S_G.plot([S_xx[r_segm[0][0]], S_xx[r_segm[0][0]]], [-100, 100], "y--o")
                    S_G.plot([S_xx[r_segm[0][1]], S_xx[r_segm[0][1]]], [-100, 100], "y--o")

                    S_A.plot([S_xx[r_segm[0][0]], S_xx[r_segm[0][0]]], [-1.2, 1.2], "y--o")
                    S_A.plot([S_xx[r_segm[0][1]], S_xx[r_segm[0][1]]], [-1.2, 1.2], "y--o")
