...
d = [[7, 200], [40, 6500], [10, 240], [20, 300], 120]  # AAS3 data: lenSeg[0] Area[1] MaxMin[2] lenEjer[3], SepSeg[4]
# d = [[20, 120], [700, 6500], [40, 240], [45, 300], 60]  # AAS3 data: lenSeg[0] Area[1] MaxMin[2] lenEjer[3], SepSeg[4]
# d = [[20, 120], [800, 6300], [30, 250], [45, 300], 60]  # AAS2 data: lenSeg[0] Area[1] MaxMin[2] lenEjer[3], SepSeg[4]

cond_e = [20, 5, 10, 0.5]  # CONDICIONES ESPERAR Muestras pasadas - futuras, Pendiente?
tol_ce = [1.7, 5]  # UmbralEjerc[0] UmbralDistRegistro[1]
...
ejercicio = "08-04-2022_07-26-55_IAAB_s2.txt"
            ...
            if k == segmentar[0]:
                ...
                if (S_gy[k] * S_gy[k - 1] < -(tol_ce[0] ** 2) and sum(cero_e) == 0) or \
                    ...
                    if len(cruc_e[0]) >= 1:
                        ...
                        print("Seg:", S_xx[cruc_e[0][-1]], "-", S_xx[k], ". Validacion = ", validacion)
                ...
                if r_segm[1][0] == sec_ej[0] and r_segm[1][1] == sec_ej[1]:  # Seg. negativo->positivo
                    ...
                    if sum(re_val) == 2:
                        S_G.plot([S_xx[r_segm[0][0][0]], S_xx[r_segm[0][0][0]]], [-100, 100], "y--o")
                        S_G.plot([S_xx[r_segm[0][1][1]], S_xx[r_segm[0][1][1]]], [-100, 100], "y--o")

                        S_A.plot([S_xx[r_segm[0][0][0]], S_xx[r_segm[0][0][0]]], [-1.2, 1.2], "y--o")
                        S_A.plot([S_xx[r_segm[0][1][1]], S_xx[r_segm[0][1][1]]], [-1.2, 1.2], "y--o")
