    ...
    def update_plot():
        try:
            ...
            if data != 'Q':
                ...
                ax.set_ylim(0, 3.5)
                # ax.set_xlim(0, x[-1]len(lista_ecg))
                # ax.grid()
        ...
        window.after(20, update_plot)

    window.after(20, update_plot)  # Inicia la actualización de la gráfica
...
def simulation(q):
    ...
    puerto = 3333
    ip = "192.168.10.132"  # Reemplaza con tu IP local
