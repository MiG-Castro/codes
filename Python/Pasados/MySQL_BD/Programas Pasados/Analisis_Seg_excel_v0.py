...
# Imp[0], IIR[1], Graf[2], T=Unico F=Bucle[3], ID_ej[4], Ini_Bucle[5], NoPyt_E_Omitir[6], G_Excel[7]
config = [True, False, True, False, 6, 0, [], False]
...
if not config[3]:  # BUCLE
    ...
    for n in vector_e:                                  # INICIO DE BUCLE ##############################################
        e1 = sf(e_selec[n][4])
...
"""
# ANALISIS PASADO DE FUNCIONAMIENTO CON UN SOLO EJERCICIO 
