...
config = [False, True, True, False, 110, 0, [], False]
# [60, 62, 63, 64, 65, 66, 105, 171, 172, 174, 176, 180, 181, 184, 189]
crit_e = ["FE", 2]                      # Ejercicio[0], Sensor[1]
tolerancia_cruce = [0.05, 5, 50]        # IntervaloCero[0] UmbralDistCruces[2] UmbralDist_IniFinEjer[3]
