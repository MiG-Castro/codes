...
config = [False, True, True, False, 0, 0, [], False]  # 160 +-1 inter
crit_e = ["AA", 2]  # Ejercicio[0], Sensor[1]
...
"""
    # APLICACION PARA AA - AAM <-> S2 - S3 *****************************************************************************
    config = [False, True, True, False, 144, 0, [105, 160, 194], False]  # 160 +-1 inter
    crit_e = ["AAM", 2]  # Ejercicio[0], Sensor[1]
    tolerancia_cruce = [1, 5, 15]  # IntervaloCero[0] UmbralDistCruces[2] UmbralDist_IniFinEjer[3]
