...
config = [False, True, True, False, 0, 0, [], False]  # 160 +-1 inter 922
SoloVer = False
crit_e = [2, "IFERB", "I"]  # Sensor[0], Ejercicio[1], Extremidad[2]
...
resultados = []
info_BD_tabla = ["nuevo_amanecer", "ejercicios_segmentador"]
