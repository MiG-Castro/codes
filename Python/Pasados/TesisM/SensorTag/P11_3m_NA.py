...
save_path = r"D:\MACP_\Documents\Escuela\CICESE\Doctorado\Trabajo\NocheCiencias\ "
...
ON = Button(plt.axes([0.925, 0.9, 0.05, 0.05]), 'Pausa', color="gray")

E1 = Button(plt.axes([0.925, 0.75, 0.05, 0.05]), Bt_Text[0], color="gray")
E2 = Button(plt.axes([0.925, 0.68, 0.05, 0.05]), Bt_Text[1], color="gray")
E3 = Button(plt.axes([0.925, 0.61, 0.05, 0.05]), Bt_Text[2], color="gray")
E4 = Button(plt.axes([0.925, 0.49, 0.05, 0.05]), Bt_Text[3], color="gray")
E5 = Button(plt.axes([0.925, 0.42, 0.05, 0.05]), Bt_Text[4], color="gray")
E6 = Button(plt.axes([0.925, 0.225, 0.05, 0.05]), Bt_Text[5], color="gray")
EX_B = Button(plt.axes([0.925, 0.1, 0.05, 0.07]), 'B. R', color="gray")
EX_M = Button(plt.axes([0.925, 0.01, 0.05, 0.07]), 'M. R', color="gray")
