...
#    img3 = ImageTk.PhotoImage(img3.resize((400, 400)))
    img4 = Image.open("YODA.jpg")
#    img4 = ImageTk.PhotoImage(img4.resize((400, 400)))
    imagenes_p=Label()
    imagenes_p.pack()

    global d,e,f,d_auxiliar
    while True:
        if d_auxiliar == 0:
...
def animate(i):
    global S3_xx, S3_gx, S3_gy, S3_gz, S3_ax, S3_ay, S3_az, S3_min, S2_xx, S2_gx, S2_gy, S2_gz, S2_ax, S2_ay, S2_az, \
        S2_min, lengthVector, Iniciar, ultimo, Total_E, Pausa, d, e, f, d_auxiliar, time_last
