...
# Archivo a leer
file = "Pruebas_BLE/1m_60HzTx/5m/2025-04-01_16-14-10_None-0.bin"
...
if unpack:
    ...
    if sec[-1] != 17999:
        ...
        print("Ultimo paquete:", sec[-1], ", Paquetes esperados:", 18000, 
              "Diferencia: ", 18000 - (sec[-1] + 1), ", Perdidas totales: ", 18000 - (sec[-1] + 1) + sum(loss_pkts), "\n")
